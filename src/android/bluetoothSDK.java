...
public class BluetoothSDK extends CordovaPlugin {
  ...
  void onLight(CordovaArgs args, CallbackContext callbackContext) throws JSONException {
    int addr = args.getInt(0);
    mService.setOnoff((short)addr, Util.PL_SIG_ONOFF_SET_ON, Util.PL_DEFAULT_ONOFF_TRANSITIONTIME, Util.PL_DEFAULT_ONOFF_DELAY, Util.PL_DEFAULT_APP_KEY_INDEX, true);
    callbackContext.success();
  }
  ...
  void offLight(CordovaArgs args, CallbackContext callbackContext) throws JSONException {
    int addr = args.getInt(0);
    mService.setOnoff((short)addr, Util.PL_SIG_ONOFF_SET_OFF, Util.PL_DEFAULT_ONOFF_TRANSITIONTIME, Util.PL_DEFAULT_ONOFF_DELAY, Util.PL_DEFAULT_APP_KEY_INDEX, true);
    callbackContext.success();
  }
}
