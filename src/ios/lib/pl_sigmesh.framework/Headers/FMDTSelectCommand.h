...
- (FMDTSelectCommand *)orderByAscendingLimit:(NSString *)key limit:(NSString*)limit;
- (FMDTSelectCommand *)orderByDescendingLimit:(NSString *)key limit:(NSString*)limit;
